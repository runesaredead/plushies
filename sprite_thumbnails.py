...
def extract_thumbnails_from_sheet(sheet_path, sheet_number=0, base_index=0, rows=6, cols=6):
...
def extract_thumbnails():
    ...
    for sheet_info in sheets:
        ...
        thumbnails_in_sheet = extract_thumbnails_from_sheet(path, sheet_number, base_index, rows, cols)
